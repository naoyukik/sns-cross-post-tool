use crate::bluesky::application::dto::facet_dto::{
    FacetDto, FacetFeatures, FacetIndex, FeatureMode,
};
use regex::{Captures, Match, Regex};

pub fn create_facets(message: &str) -> Vec<FacetDto> {
...
fn create_tags_facets(message_content: &str) -> Vec<FacetDto> {
...
fn create_links_facets(message_content: &str) -> Vec<FacetDto> {
...
fn to_facet_dto(capture_group: Match, feature_mode: FeatureMode) -> FacetDto {
